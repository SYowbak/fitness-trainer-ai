...
- Поле "name" має бути КОНКРЕТНОЮ НАЗВОЮ ВПРАВИ (наприклад, "Жим ногами лежачи", "Гіперекстензія без ваги")
- ЗАБОРОНЕНО в "name" фрази: "альтернатива", "заміна", "безпечна версія", "безпечна альтернатива"
- Всі пояснення чому вправа замінена — тільки в "recommendation.text" або "notes"
- НЕ вставляй в "name" пояснювальний текст — тільки назва вправи!`;
};
