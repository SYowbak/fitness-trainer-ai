import { Gender, BodyType, FitnessGoal, MuscleGroup } from './types';
...
export const DEFAULT_WEIGHT_INCREMENT = 2.5; // kg for example
export const DEFAULT_WEIGHT_DECREMENT = 2.5; // kg for example
...
export const UI_TEXT = {
  ...
  notes: "Примітки:",
  imageSuggestion: "Ідея для зображення/GIF:",
