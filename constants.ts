...
export const UI_TEXT = {
  ...
  exerciseInstructions: "Інструкції до вправи:",
  ...
  notes: "Примітки:",
  videoSuggestion: "Пропозиція відео:",
  ...
  confirmEndWorkout: "У вас є активне тренування. Ви впевнені, що хочете його завершити?",
  ...
  setCompletedSuccessfully: "Підхід виконано успішно",
  allSetsCompletedSuccessfully: "Усі підходи виконано успішно",
  addSet: "Додати підхід",
  removeLastSet: "Видалити останній підхід"
};
