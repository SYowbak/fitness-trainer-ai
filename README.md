...
```bash
# Скопіюйте шаблон та створіть .env.local файл:
cp env.template .env.local

# Відредагуйте .env.local та додайте ваш API ключ:
# VITE_API_KEY=your_gemini_api_key_here
#
# Отримайте ключ на: https://makersuite.google.com/app/apikey
# Або скопіюйте з Vercel: Settings -> Environment Variables -> VITE_API_KEY
```
